...
class LargeTextField extends StatelessWidget {
  ...
  const LargeTextField({Key? key, required this.label, required this.isNumberInput, required this.width, required this.onChanged, this.defaultText}) : super(key: key);
